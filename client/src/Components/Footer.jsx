...
const Footer = () => {
  ...
  return (
    <footer
      className="bg-slate-950 border-t border-slate-800/50"
      ...
      <div className="mx-auto max-w-7xl px-6 py-12 sm:py-16 lg:px-8">
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          <div className="space-y-4">
            <span className="text-2xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">
              Brieflab
            </span>
            <p className="text-sm leading-6 text-slate-400 max-w-md mx-auto">
              AI-powered platform for automatic, context-aware summaries and
              question answering from any YouTube video or article.
            </p>
          </div>
